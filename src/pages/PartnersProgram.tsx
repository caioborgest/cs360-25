  ...
  return <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button size="lg" className="text-lg px-10 py-4 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {partnerTypes.map((type, index) => <Card key={index} className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-3 border-0 overflow-hidden">
                ...
                <CardContent>
                  ...
                  <Button className="w-full group-hover:text-white transition-colors bg-green-700 hover:bg-green-600 font-medium">
                    Escolher Este Plano
                  </Button>
                </CardContent>
              </Card>)}
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button size="lg" className="bg-white text-green-600 hover:bg-gray-100 text-lg px-10 py-4">
              <Handshake className="w-6 h-6 mr-3" />
              Candidatar-se Agora
            </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 text-lg">
                Programa de Parceiros CS360° - Cresça conosco e maximize seus ganhos no mercado de Customer Success.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">Programa de Parceiros</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Portal do Parceiro</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Recursos de Marketing</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-center"><Mail className="w-4 h-4 mr-2" /> parceiros@cs360.com</li>
