...
export const PricingAddOns = () => {
  ...
  return <section className="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          return <Card key={index} className="relative overflow-hidden hover:shadow-2xl transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="pt-0">
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                      {addon.pricing.map((item, idx) => <div key={idx} className="bg-gray-50 rounded-lg p-3">
                          <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">
                            {item.plan}
                          </div>
                          <div className="flex items-baseline">
                            <span className={`text-lg font-bold ${item.price === 'Incluído' || item.price === 'Ilimitado' ? 'text-green-600' : 'text-gray-900'}`}>
                              {item.price}
                            </span>
                    ...
                    <div className="pt-3 border-t border-gray-100">
                      ...
                      <ul className="space-y-1">
                        {addon.features.map((feature, featureIdx) => <li key={featureIdx} className="text-sm text-gray-600 flex items-center">
                    ...
                    <Button variant="outline" className="w-full mt-4 bg-green-700 hover:bg-green-600 text-slate-100">
