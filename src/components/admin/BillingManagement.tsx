        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full">Alterar Método de Pagamento</Button>
              <Button variant="ghost" className="w-full text-red-600">Cancelar Assinatura</Button>
            </div>
          </div>
        </CardContent>
      </Card>
